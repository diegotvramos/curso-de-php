...
<body>
    <div class="container mt-5">
        <form action="../controlador/transacciones.php" method="post" enctype="multipart/form-data"> <!--se escribe method--> <!---->
            <div class="text-center text-primary mb-4 col">
                <h5 class="fw-bold">FORMULARIO CON POO Y PDO</h5>
            </div>
            ...
            <div class="row mb-3 justify-content-center">
                <div class="col-auto">
                    <a href="ver_blog.php" class="btn btn-primary s">mostrar blog</a>
                </div>   
            </div>
