...
<body>
        ...
        <div class="container">
        <form method="get" action="vid44_eliminar_registro.php" class="mt-5"> <!--mt= margin top de 5--><!--el metodo get nos permite q la informacion viaje entre paginas-->
            <h3 class="text-center mb-4">ELIMINACION DE ARTICULOS</h3>
            <div class="row mb-3">
            ...
            <button type="submit" class="btn btn-outline-danger">ELIMINAR</button><!--buscar 'buttons' en bootstrap-->
