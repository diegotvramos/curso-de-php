...
<div class="text-center mt-5 mb-5"><!--alineacion de texto https://getbootstrap.com/docs/5.2/utilities/text/#text-alignment-->
    <h1 class="fs-5 fw-bold text-primary">BUSCA LA IMAGEN</h1>
</div>

    <form action="leer_imagen.php" method="post"> <!--usamos el metodo POST por q vmos a tratar un archivo-->
        ...
        <div class="row justify-content-center">
            <div class="col-auto">
                <button type="submit" class="btn btn-success" name="enviar">buscar imagen</button>
            </div>   
        </div>
